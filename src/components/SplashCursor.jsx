...
function isInsideActiveArea(clientX, clientY) {
...
function resetPointerPosition(pointer, posX, posY, color) {
...
function handleMouseDown(e) {
  if (!isInsideActiveArea(e.clientX, e.clientY)) return;

  const pos = getLocalPointerPosition(e.clientX, e.clientY);
  if (!pos) return;
...
function handleMouseMove(e) {
  ...
  if (!isInsideActiveArea(e.clientX, e.clientY)) {
  ...
  if (!firstMouseMoveHandled) {
    resetPointerPosition(pointer, pos.x, pos.y, generateColor());
...
return (
  <div className={`splash-cursor-layer ${className}`}>
    <canvas
      ref={canvasRef}
      id="fluid"
      style={{
